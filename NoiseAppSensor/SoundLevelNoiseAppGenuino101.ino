...
int sensorValue = 0;
int bias_level = 500;
String SENSOR_NAME = "PUT HERE THE SENSOR_NAME";
String SENSOR_LATITUDE = "PUT HERE YOUR LATITUDE";
String SENSOR_LONGITUDE = "PUT HERE YOUR LONGITUDE";
...
void loop() {
  ...
  float voltage = (adc_ac / 1024.0) * 3.3;
